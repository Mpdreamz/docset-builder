namespace AsciiDocNet
{
	public static class Patterns
	{
		...
		public static readonly char[] LowerAlphabet = "abcdefghijklmnopqrstuvwxyz".ToCharArray();
		public static readonly char[] UpperAlphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ".ToCharArray();
